...
//
//        nm.createNotificationChannel(NotificationChannel(Notifications.Channel.DAILY_REMINDER_ID, context.getString(R.string.channel_daily_reminder), NotificationManager.IMPORTANCE_HIGH))
//
...
//                    if (!d.isFinished) {
//                        when (d.type) {
//                            Lms.TYPE_LESSON -> classes.add(context.getString(R.string.reminder_class_format, d.className, d.week, d.lesson))
//                            Lms.TYPE_SUP_LESSON -> supClasses.add(context.getString(R.string.reminder_class_format, d.className, d.week, d.lesson))
//                            Lms.TYPE_HOMEWORK -> homeworks.add(context.getString(R.string.reminder_zoom_format, d.className, d.homework_name))
//                            Lms.TYPE_ZOOM -> zooms.add(context.getString(R.string.reminder_zoom_format, d.className, d.homework_name))
//                            Lms.TYPE_TEAMWORK -> teamworks.add(context.getString(R.string.reminder_zoom_format, d.className, d.homework_name))
//                            Lms.TYPE_EXAM -> tests.add(context.getString(R.string.reminder_zoom_format, d.className, d.homework_name))
//                        }
//                    }
//                }
//            }
...
//                        NotificationCompat.Builder(context, Notifications.Channel.DAILY_REMINDER_ID).apply {
...
//                            )
//                            setContentIntent(PendingIntent.getActivity(context, PendingReq.MORNING_REMINDER_LAUNCH, Intent(context, MainActivity::class.java), PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE))
//                            setSmallIcon(R.drawable.ic_reminder_icon)
//                            setAutoCancel(true)
//                            color = ContextCompat.getColor(context, R.color.colorPrimary)
//
//                            if (content.isNotEmpty() && !sharedPreferences.getBoolean(SharedKey.DND_CHECK, false) && (!Utils.isDNDTime(dndStartData, dndEndData, nowInt))) {
//                                nm.notify(Notifications.Id.REMINDER, build())
//                            }
//                        }
//                    }
//                }
...
//                                .bigText(context.getString(R.string.daily_reminder_content_format, content.joinToString(", "), bigTextContent.joinToString("\n\n")))
//                            )
//                            setContentIntent(PendingIntent.getActivity(context, PendingReq.NIGHT_REMINDER_LAUNCH, Intent(context, MainActivity::class.java), PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE))
//                            setSmallIcon(R.drawable.ic_reminder_icon)
//                            setAutoCancel(true)
//                            color = ContextCompat.getColor(context, R.color.colorPrimary)
//
