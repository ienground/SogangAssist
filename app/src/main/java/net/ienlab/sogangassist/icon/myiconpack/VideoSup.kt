...
public val MyIconPack.VideoSup: ImageVector
    get() {
        if (_videoSup != null) {
            return _videoSup!!
        }
        _videoSup = Builder(name = "VideoSup", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _videoSup: ImageVector? = null
