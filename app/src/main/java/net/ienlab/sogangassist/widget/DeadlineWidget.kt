...
//    private val unfinishedEvents: ArrayList<Lms> = arrayListOf()
//
...
//    }
//
//    fun setWidgetData(context: Context, views: RemoteViews, item: List<Lms>, i: Int) {
//        if (item.isNotEmpty()) {
...
//                Lms.TYPE_SUP_LESSON, Lms.TYPE_LESSON -> context.getString(R.string.week_lesson_format, item[index].week, item[index].lesson)
...
//                views.setTextViewText(R.id.tv_deadline, context.getString(if (item[index].type == Lms.TYPE_ZOOM) R.string.deadline_zoom_format_past else R.string.deadline_format_past, -(timeDifference / 60), -(timeDifference % 60)))
//            } else {
//                views.setTextViewText(R.id.tv_deadline, context.getString(if (item[index].type == Lms.TYPE_ZOOM) R.string.deadline_zoom_format else R.string.deadline_format, timeDifference / 60, timeDifference % 60))
//            }
//
//            views.setImageViewResource(R.id.background_logo, when (item[index].type) {
//                Lms.TYPE_LESSON -> R.drawable.ic_video
//                Lms.TYPE_SUP_LESSON -> R.drawable.ic_video_sup
//                Lms.TYPE_HOMEWORK -> R.drawable.ic_assignment
//                Lms.TYPE_ZOOM -> R.drawable.ic_live_class
//                Lms.TYPE_TEAMWORK -> R.drawable.ic_team
//                Lms.TYPE_EXAM -> R.drawable.ic_test
