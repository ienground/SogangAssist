...
class LinePagerIndicatorDecoration: RecyclerView.ItemDecoration() {
    ...
    private val colorActive = 0xFFFFFF
    private val colorInactive = 0x66FFFFFF

    private final val DP = Resources.getSystem().displayMetrics.density

    /**
     * Height of the space the indicator takes up at the bottom of the view.
     */
    private final val mIndicatorHeight = (DP * 16).toInt()

    /**
     * Indicator stroke width.
     */
    private final val mIndicatorStrokeWidth = DP * 2

    /**
     * Indicator width.
     */
    private final val mIndicatorItemLength = DP * 16
    /**
     * Padding between indicators.
     */
    private final val mIndicatorItemPadding = DP * 4

    /**
     * Some more natural animation interpolation
     */
    private final val mInterpolator = AccelerateDecelerateInterpolator()

    private final val mPaint = Paint()
