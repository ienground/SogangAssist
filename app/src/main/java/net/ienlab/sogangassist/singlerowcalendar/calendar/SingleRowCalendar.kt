...
import net.ienlab.sogangassist.singlerowcalendar.utils.DateUtils
import net.ienlab.sogangassist.singlerowcalendar.selection.CalendarDetailsLookup
import net.ienlab.sogangassist.singlerowcalendar.selection.CalendarKeyProvider
...
open class SingleRowCalendar(context: Context, attrs: AttributeSet) : RecyclerView(context, attrs) {
